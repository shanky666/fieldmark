...
export const firebaseConfig = {
  ...
  authDomain:        env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN        || 'fieldmark-atia-c178d.firebaseapp.com',
  projectId:         env.EXPO_PUBLIC_FIREBASE_PROJECT_ID         || 'fieldmark-atia-c178d',
  storageBucket:     env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET     || 'fieldmark-atia-c178d.firebasestorage.app',
