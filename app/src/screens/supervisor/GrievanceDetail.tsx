...
type GrievanceDetailRouteProp = RouteProp<SupervisorStackParamList, 'GrievanceDetail'>;
type GrievanceDetailNavigationProp = StackNavigationProp<SupervisorStackParamList, 'GrievanceDetail'>;

interface GrievanceDetailProps {
  route: GrievanceDetailRouteProp;
  navigation: GrievanceDetailNavigationProp;
}

export default function GrievanceDetail({ route, navigation }: GrievanceDetailProps) {
